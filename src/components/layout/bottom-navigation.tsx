...
export default function BottomNavigation() {
  return (
    <nav className="max-w-[600px] mx-auto fixed bottom-0 left-0 right-0 z-50 flex h-14 w-full items-center justify-around bg-background shadow-t  dark:shadow-t-gray-800">
      <Link
        href="/home"
